...
class Post(models.Model):
    ...
    upvoters = models.ManyToManyField(Author, related_name='upvoted_posts', blank=True, null=True)
    downvoters = models.ManyToManyField(Author, related_name='downvoted_posts', blank=True, null=True)
